                ...
                <form
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('merk') is-invalid @enderror" id="merk"
                            name="merk" value="{{ old('merk', isset($kendaraan) ? $kendaraan->merk : '') }}" required>
                        @error('merk')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nopol') is-invalid @enderror" id="nopol"
                            name="nopol" value="{{ old('nopol', isset($kendaraan) ? $kendaraan->nopol : '') }}" required>
                        @error('nopol')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('thn_beli') is-invalid @enderror" id="thn_beli"
                            name="thn_beli" value="{{ old('thn_beli', isset($kendaraan) ? $kendaraan->thn_beli : '') }}"
                            required>
                        @error('thn_beli')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <select class="form-control @error('jenis_kendaraan_id') is-invalid @enderror"
                            ...
                            @foreach ($jenisKendaraans as $jenis)
                                <option value="{{ $jenis->id }}"
                                    {{ old('jenis_kendaraan_id', isset($kendaraan) ? $kendaraan->jenis_kendaraan_id : '') == $jenis->id ? 'selected' : '' }}>
                                    {{ $jenis->nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('rating') is-invalid @enderror" id="rating"
                            name="rating" value="{{ old('rating', isset($kendaraan) ? $kendaraan->rating : '') }}"
